    ...
    <AuroraBackground>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center text-center px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          ...
          <button className="flex items-center gap-2 px-6 py-3 rounded-full bg-black text-white font-semibold text-lg transition duration-200 hover:bg-transparent hover:shadow-lg">
